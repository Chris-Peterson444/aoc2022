# I really struggled with part two of this one. Supposedly this can be solved using the 
# Chinese Remainder Theorem: https://en.wikipedia.org/wiki/Chinese_remainder_theorem

# Copied solution from reddit user u/dedolent
# https://www.reddit.com/r/adventofcode/comments/zifqmh/comment/j20io2y/?utm_source=share&utm_medium=web2x&context=3

# I will have to re-visit this one when I have more time to understand it. 

# The following work for part 2 is from u/dedolent:
